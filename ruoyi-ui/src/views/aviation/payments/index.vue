    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['aviation:payments:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['aviation:payments:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['aviation:payments:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['aviation:payments:export']"
        >导出</el-button>
      </el-col>
...
<script>
import { listPayments, getPayments, delPayments, addPayments, updatePayments } from "@/api/aviation/payments";
...
export default {
  ...
  methods: {
    ...
    handleUpdate(row) {
      ...
      getPayments(paymentId).then(response => {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('aviation/payments/export', {
        ...this.queryParams
